...
F2.Animate.registerAnimation('lineUpdate', function(updateShape, animateCfg) {
    var cacheShape = updateShape.get('cacheShape'); 
    var cacheAttrs = cacheShape.attrs; 
    var geomType = cacheShape.geomType; 
    var oldPoints = cacheAttrs.points;
    var newPoints = updateShape.attr('points');
